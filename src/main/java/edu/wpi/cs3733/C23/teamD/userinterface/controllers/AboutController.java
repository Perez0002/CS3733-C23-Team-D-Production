...
public class AboutController {
  ...
  public void initialize() {
    ...
    imageFour.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageFour.setFitHeight(150);

    imageFive.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageFive.setFitHeight(150);

    imageSix.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageSix.setFitHeight(150);

    imageSeven.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageSeven.setFitHeight(150);

    imageEight.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageEight.setFitHeight(150);

    imageNine.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageNine.setFitHeight(150);

    imageTen.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageTen.setFitHeight(150);

    imageEleven.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageEleven.setFitHeight(150);

    imageTwelve.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageTwelve.setFitHeight(150);

    imageThirteen.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageThirteen.setFitHeight(150);

    imageFourteen.setViewport(new Rectangle2D(0, 0, 720, 720));
    imageFourteen.setFitHeight(150);

    imageFifteen.setViewport(new Rectangle2D(0, 0, 720, 720));
