...
public class SecurityServiceRequestController extends ServiceRequestController {
   @FXML
   private Parent staffDropdownBox;
   @FXML
   private EmployeeDropdownComboBoxController staffDropdownBoxController;
   @FXML
   private Parent locationDropdownBox;

   @FXML
   private RoomPickComboBoxController locationDropdownBoxController;

   @FXML
   private Parent urgencyDropdownBox;
   @FXML
   private UrgencySelectorBoxController urgencyDropdownBoxController;
   @FXML
   private MFXCircleToggleNode addSecurityNode;
   @FXML
   private MFXCircleToggleNode addRequestSecurityNode;
   @FXML
   private MFXTextField problemTextField;
   ...
   public void submit()
   {
      ...
      SecurityServiceRequest securityServiceRequest = new SecurityServiceRequest(
        typeOfRequest, urgencyDropdownBoxController.getEmployeeName(), staffDropdownBoxController.getEmployeeName(), ServiceRequest.Status.PROCESSING, problemTextField.getText()
      );
