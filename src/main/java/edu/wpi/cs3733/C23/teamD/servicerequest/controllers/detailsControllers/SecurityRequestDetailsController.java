...
public class SecurityRequestDetailsController implements RequestDetailsController {
  ...
  public SecurityRequestDetailsController() {}
  ...
  public void setFields(ServiceRequest serviceRequest) {
    ...
    if (serviceRequest.getClass().equals(SecurityServiceRequest.class)) {
      ...
      additionalField.setText(
          "Type of Request: "
              + ((SecurityServiceRequest) serviceRequest).getTypeOfSecurityRequest());
